...
add wave -noupdate -radix unsigned /MMM_tb/dut/fifoCapacity
...
add wave -noupdate -divider -height 25 {Delay Registers}
add wave -noupdate /MMM_tb/dut/clearAccDelay1
add wave -noupdate /MMM_tb/dut/clearAccDelay2
add wave -noupdate /MMM_tb/dut/fifoWriteEnableDelay1
add wave -noupdate /MMM_tb/dut/fifoWriteEnableDelay2
add wave -noupdate /MMM_tb/dut/validDelay1
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 3} {475 ns} 0}
